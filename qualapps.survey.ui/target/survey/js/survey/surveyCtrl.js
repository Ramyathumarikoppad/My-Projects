				...
				[
						...
						function($scope, $location, $http, mainService) {
							...
							$scope.save = function(survey, questions) {
								...
								/*
								 * var getsurveyID =
								 * mainService.getsurveyID(survey);
								 * getsurveyID.then(function(msg) { var surveyid =
								 * msg.data.vo.surveyId; if (msg.data.status ==
								 * true) { var getquestionID =
								 * mainService.getquestionID(question,
								 * surveyid); getquestionID.then(function(msg) {
								 * if (msg.data.status == true) { var questionid =
								 * msg.data.vo.questionId;
								 * 
								 * var answerid =
								 * mainService.getanswerID(answer, questionid);
